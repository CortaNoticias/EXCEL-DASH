    ...
    >
      <CardHeader className="pb-4">
        <CardTitle className={`flex items-center gap-2 ${isUsingRealData ? "text-green-800" : "text-blue-800"}`}>
          ...
          {isUsingRealData ? "Datos Oficiales de JUNAEB" : "Dashboard de Análisis de Multas PAE-PAP"}
        </CardTitle>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
              ...
              <div className={`text-sm ${isUsingRealData ? "text-green-800" : "text-amber-800"}`}>
                {isUsingRealData ? (
                  <div>
                    ...
                    <p>
                      Los datos se cargan directamente desde el repositorio oficial de JUNAEB en GitHub. Archivos:
                      "Multas Junaeb - Base de datos (TPA) [AÑO].json"
                    </p>
                  </div>
                ) : (
                  <div>
          ...
          {isUsingRealData && (
            <div className="bg-white p-3 rounded-lg border border-green-200">
              ...
              <p className="text-xs text-green-700">Archivos: "Multas Junaeb - Base de datos (TPA) 2020-2023.json"</p>
            </div>
          )}
